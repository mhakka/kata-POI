...
public class POIServiceImplTest {
    ...
    private List<POI> inputPOIs;
    
    @Before
    public void setUp() {
        inputPOIs = new ArrayList<>();
     ...
     */
    @Test
    public void testGetNbrPOIsOfArea() {
        //Given
        Area area = new Area(6.5F, 7F, -7F, -6.5F);
        POIServiceImpl instance = new POIServiceImpl();
        
        //when
        long result = instance.getNbrPOIsOfArea(inputPOIs, area);
     ...
     */
    @Test
    public void testGetDensestAreas() {
        //Given
        ...
        //When
        List<Area> result = instance.getDensestAreas(inputPOIs, 2);
